<?php 
  ...
  if(isset($_GET['fetch_rooms']))
  {
   ...
   $children = ($guests['children']!='') ? $guests['children'] : 0;
    ...
    //fetching settings table to check
    $settings_q = "SELECT * FROM `Settings` WHERE `crt_no`=1";
        ...
        <div class='card mb-4 border-0 shadow'>
          <div class='row g-0 p-3 align-items-center'>
            ...
            <div class='col-md-2 text-center;>
              ...
              $book_btn
              <a href='room_details.php?id=$room_dta[id]' class='btn btn-sm btn-outline-dark shadow-none mb-2'>More details</a>
            </div>
