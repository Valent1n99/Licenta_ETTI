...
require('/Applications/XAMPP/xamppfiles/htdocs/Licenta/admin/inc/essentials.php');
  ...
  if(isset($_POST['add_room']))
  {
    ...
    $q1 = "INSERT INTO `rooms` (`name`, `area`, `price`, `quantity`, `adult`, `children`, `description`, `removed`) VALUES (?,?,?,?,?,?,?,?)";
    $values = [$frm_data['name'],$frm_data['area'],$frm_data['price'],$frm_data['quantity'],$frm_data['adult'],$frm_data['children'],$frm_data['desc'],0];
