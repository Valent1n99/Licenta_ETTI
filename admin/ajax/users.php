<?php 
  ...
  if(isset($_POST['toggle_status']))
  {
    ...
    $q = "UPDATE `user_crew` SET `status`=? WHERE `id`=?";
  ...
  if(isset($_POST['remove_user']))
  {
    ...
    $res = delete("DELETE FROM `user_crew` WHERE `id`=? AND `is_verified`=?",[$frm_data['user_id'],0],'ii');
  ...
  if(isset($_POST['search_user']))
  {
    ...
    $query = "SELECT * FROM `user_crew` WHERE `name` LIKE ?";
